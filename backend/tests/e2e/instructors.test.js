...
describe("get to see", () => {
  test("a instructor", async () => {
    await request.get("/instructors").expect(200)
  })
  ...
  test("instructors", async () => {
    ...
    await request.get(`/instructors/${response.body._id}`).expect(200)
  })
})
...
describe("create and delete a instructor", () => {
  ...
  test("delete a instructor", async () => {
    ...
    await request.delete(`/instructors/${response.body._id}`).expect(200)
  })
})
