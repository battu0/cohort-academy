...
const howSoftwareAteFinance = Course.create({
	name: "How Software Ate Finance",
	subject: "Finance",
	instructors: ["R. Martin Chavez", "Jeffrey Conn"],
});
const financialMarkets = Course.create({
	name: "Financial Markets",
	subject: "Finance",
	instructors: ["Robert Shiller"],
});
const learningHowToLearn = Course.create({
	name: "Learning How To Learn",
	subject: "Personal Development",
	instructors: ["Barbara Oakley", "Dr. Terrence Sejnowski"],
});
